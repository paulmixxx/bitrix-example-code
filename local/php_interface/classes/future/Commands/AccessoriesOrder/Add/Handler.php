...
namespace Future\Commands\AccessoriesOrder\Add;
...
class Handler
{
    ...
    public function handle(Command $command)
    {
        ...
        $vendorCodeList = array_column($requestElement["PROPERTIES"]["ACCESSORIES"]["VALUE"], "VENDOR_CODE");
        $sparePartsList = [];
        $arSelect = [];
        $arFilter = [
        ...
        foreach ($requestElement["PROPERTIES"]["ACCESSORIES"]["VALUE"] as $item) {
