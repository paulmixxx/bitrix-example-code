...
namespace Future\Commands\SparePartsRequest\Update;
...
class Handler
{
    ...
    public function handle(Command $command)
    {
        ...
        $vendorCodeList = array_column($properties["SPARE_PARTS"], "VENDOR_CODE");
        $sparePartsList = [];
        $arSelect = [];
        $arFilter = [
        ...
        $properties["STATUS"] =
            $command->SAVE_FINAL === 'Y'
                ...
                : $element["PROPERTIES"]["STATUS"]["VALUE_ENUM_ID"];
