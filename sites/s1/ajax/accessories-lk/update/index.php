...
use Future\Commands\AccessoriesRequest\Update\Command;
use Future\Commands\AccessoriesRequest\Update\Handler;
...
try {
    ...
    if ($command->SAVE_FINAL === "Y") {
        $commandOrder = new \Future\Commands\AccessoriesOrder\Add\Command();
        $handlerOrder = new \Future\Commands\AccessoriesOrder\Add\Handler($USER);
